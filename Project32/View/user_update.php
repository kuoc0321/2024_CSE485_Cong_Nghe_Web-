...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (updateRole($username, $newRole)) {
...
<body>
    <br>
    <br>
    <h3 class="text-center" style="font-family: 'YourDesiredFont', sans-serif; font-weight: bold; text-decoration: underline;">User Update</h3>
    <div class="container">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"> New Role</span>
                                <input type="text" class="form-control" placeholder="NewRole" aria-label="Role" aria-describedby="addon-wrapping" name="NewRole">
                            </div>
                            <br>
