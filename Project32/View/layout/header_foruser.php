    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class = "nav-link active" href="../View/user.php">User</a>
                            </li>

                            <li class="nav-item">
                                <a class = "nav-link active" href="../View/Department.php">Department</a>
                            </li>

                            <li class="nav-item">
                                <a class = "nav-link active" href="../View/Employee.php">Employee</a>
                            </li>
